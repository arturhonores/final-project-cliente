        ...
        <div className='max-w-7xl px-4 mx-auto'>
            <div className='h-screen flex flex-col justify-center items-center gap-8 md:flex-row'>
                <section className='text-center space-y-4 md:w-1/2 md:text-left'>
                    <h1 className='text-4xl font-bold text-slate-700 lg:text-5xl xl:text-6xl'>Change Your Relationship With Money</h1>
                    <p className='italic text-azul-oscuro md:text-lg'>Enjoy guilt-free spending and effortless saving with a friendly, flexible App for managing your finances.</p>
                </section>
