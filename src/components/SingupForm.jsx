...
const SingupForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
            ...
            <button className="bg-verde-oscuro w-1/5 rounded-lg mx-auto py-2 text-white" type='submit' disabled={loadingImage}>{loadingImage ? '...Cargando imagen' : 'Enviar'}</button>
        </form>
    )
}
